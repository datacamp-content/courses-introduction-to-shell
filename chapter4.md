...
description: >-
  Die meisten Befehle der shell können mehrere Dateien gleichzeitig bearbeiten.
  In diesem Kapitel erfährst du, wie du deine eigenen Pipelines dafür einrichten
...
`@possible_answers`
- Die shell zeigt ' `last` ' an, weil die Dateien ' ' und ' `year.csv` ' nicht da sind.
- Die Shell löscht „ `current.csv` “.
- [Beides.]
- Nichts.

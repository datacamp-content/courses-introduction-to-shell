...
sin embargo,
la gente tecleaba instrucciones en un programa llamado **shell de línea de comandos**.
...
y luego muestra un *aviso* para indicar que está preparado para aceptar la siguiente orden.
...
Cada uno se identifica por una **ruta absoluta**
...
(abreviatura de "**imprimir** **directorio de** **trabajo**").
...
escribe `ls` (que es la abreviatura de "**listado**") y pulsa la tecla intro.
Por sí sola,
...
(normalmente llamado tu **directorio personal**).
...
Una trayectoria absoluta es como una latitud y una longitud: tiene el mismo valor estés donde estés. Una **ruta relativa**, en cambio, especifica una ubicación a partir de donde te encuentras: es como decir "20 kilómetros al norte".
...
subir un nivel hasta su directorio padre
...
*no* por debajo de tu directorio personal).

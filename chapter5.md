...
Das sagt der Shell (die einfach ein Programm namens „ `bash` “ ist),
...
Eine Datei voller Befehle der shell wird als**\*Shell-Skript** bezeichnet.
...
## Wie kann ein shell-Skript mehrere Sachen gleichzeitig machen?
